  ...
  return (
    <div className="mt-16">
      <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-lg p-8">
        <h3 className="text-2xl font-bold text-white mb-4">How to Get Your Spotify Data</h3>
        <ol className="space-y-3 text-white/80">
          ...
          <li className="flex gap-3">
            ...
            <span>Wait for Spotify's email (5-30 days for extended, 1-5 days for standard)</span>
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 w-6 h-6 rounded-full bg-green-500 text-white flex items-center justify-center text-sm font-bold">
              4
          ...
          <li className="flex gap-3">
            ...
            <span>Upload the streaming history files to analyze your data</span>
          </li>
        </ol>
