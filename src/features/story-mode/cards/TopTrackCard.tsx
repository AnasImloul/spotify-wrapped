      ...
      <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6 px-4">
        ...
        <div className="flex gap-4 sm:gap-6 md:gap-8 items-center justify-center flex-wrap">
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-300 to-purple-500 bg-clip-text text-transparent">
          ...
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-pink-300 to-pink-500 bg-clip-text text-transparent">
