...
export function ItemTimeline({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto border-green-500/30 bg-black/90">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-64 overflow-y-auto custom-scrollbar">
                {chartData.map((item) => (
                  ...
                  >
                    <p className="text-xs text-white/60 mb-1">{item.month}</p>
                    <p className="text-lg font-bold text-white">{item.minutes} min</p>
